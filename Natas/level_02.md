...
#### My path: 
  ...
  - I tried downloading the image through terminal commands, but it failed.
  - Later, I noticed the path when I clicked the image URL.
  - It has "files/pixel.png" and realised that there is a directory called "files".
