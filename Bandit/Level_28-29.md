...
- Observed:
  ...
  -  <img width="600" height="334" alt="image" src="https://github.com/user-attachments/assets/a80e80a2-b34a-4c85-86fd-66971d15a3a4" />
- Check commit history:  `git log`
- <img width="600" height="675" alt="image" src="https://github.com/user-attachments/assets/b77e5ee1-ec4a-42e2-b1de-166a3ddf36b0" />
- Observed commits:
	  - `fix info leak`
	  - `add missing data`
	  - `initial commit`
