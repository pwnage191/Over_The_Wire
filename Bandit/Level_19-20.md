...
- Observed a setuid binary in the home directory: ( ls -l )
  - `bandit20-do` 
  - <img width="600" alt="image" src="https://github.com/user-attachments/assets/a129fbe1-2175-473d-a1fa-acbc5b1d1186" />
- Understood that:
...
- Tested the binary:
  - `./bandit20-do id`
  - <img width="600" alt="image" src="https://github.com/user-attachments/assets/acb6b21d-08e2-49d4-9e93-add63d040e79" />
...
- Explored directories:
  ...
  - <img width="700" alt="image" src="https://github.com/user-attachments/assets/9b7d0d0a-c556-4073-8280-b7706edd6c06" />
